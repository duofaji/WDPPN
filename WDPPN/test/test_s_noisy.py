...
if __name__ == "__main__":
    ...
    trace_test_names_8 = np.load('../dataset/noisy_data/s/trace_use_8.npy')
    trace_test_names_12 = np.load('../dataset/noisy_data/s/trace_use_12.npy')
    trace_test_names_16 = np.load('../dataset/noisy_data/s/trace_use_16.npy')
    trace_test_names_20 = np.load('../dataset/noisy_data/s/trace_use_20.npy')
    
    data_paths_8 = '../dataset/noisy_data/s/data_8.hdf5'
    data_paths_12 = '../dataset/noisy_data/s/data_12.hdf5'
    data_paths_16 = '../dataset/noisy_data/s/data_16.hdf5'
    data_paths_20 = '../dataset/noisy_data/s/data_20.hdf5'
